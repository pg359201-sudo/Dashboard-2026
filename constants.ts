...
export const MOCK_DATA: SalesRecord[] = [
    { 
        id: '1', RazonSocial: 'SUPERMERCADO CENTRAL', GEC: '51 - ORO', GrupoCanal: 'SUPERMERCADOS', RutaVenta: 'R-101', RutaDesarr: 'JUAN PEREZ', UC12mm: 1200, Var2025vs2024: 0.05, ShareREFRESCOS: 0.45, TP: 150,
    ...
    { 
        id: '2', RazonSocial: 'MINIMARKET EL SOL', GEC: '50 - DIAMANTE', GrupoCanal: 'BODEGAS', RutaVenta: 'R-102', RutaDesarr: 'MARIA GOMEZ', UC12mm: 450, Var2025vs2024: -0.02, ShareREFRESCOS: 0.30, TP: 45,
    ...
    { 
        id: '4', RazonSocial: 'RESTAURANTE LA BRASA', GEC: '51 - ORO', GrupoCanal: 'RESTAURANTES', RutaVenta: 'R-103', RutaDesarr: 'CARLOS RUIZ', UC12mm: 800, Var2025vs2024: 0.08, ShareREFRESCOS: 0.75, TP: 200,
    ...
    { 
        id: '6', RazonSocial: 'GRIFO PRIMAX', GEC: '50 - DIAMANTE', GrupoCanal: 'CONVENIENCE', RutaVenta: 'R-103', RutaDesarr: 'CARLOS RUIZ', UC12mm: 950, Var2025vs2024: 0.03, ShareREFRESCOS: 0.55, TP: 80,
