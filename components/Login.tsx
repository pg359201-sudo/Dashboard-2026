    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <svg className="absolute w-full h-full" xmlns="http://www.w3.org/2000/svg">
            ...
            <g stroke="white" strokeWidth="1" fill="none" strokeOpacity="0.15">
                ...
                {/* Central-Left Pulse - Separado del centro (38% -> 25%) */}
                <circle cx="25%" cy="50%" r="1.2" fill="white" opacity="0.1">
                    <animate attributeName="opacity" values="0.1; 0.5; 0.1" dur="3s" repeatCount="indefinite" />
                </circle>

                {/* Central-Right Blink - Separado del centro (62% -> 75%) */}
                <circle cx="75%" cy="45%" r="1.2" fill="white" opacity="0.1">
                    <animate attributeName="opacity" values="0.1; 0.6; 0.1" dur="4.5s" repeatCount="indefinite" begin="1s" />
                </circle>

                {/* Center-Top Subtle - Separado hacia arriba (25% -> 15%) */}
                <circle cx="50%" cy="15%" r="0.8" fill="white" opacity="0.1">
        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200 relative z-10">
                ...
                <div className="bg-gradient-to-br from-slate-600 via-slate-700 to-slate-800 p-8 text-center relative overflow-hidden">
                    ...
                    <h1 className="text-lg font-tech font-medium text-white relative z-10 tracking-wider uppercase -mt-2 whitespace-nowrap">Sales·Commander Pro</h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-8">
                    <div className="mb-6">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="block w-full pl-10 pr-3 h-10 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none transition-all shadow-sm text-sm"
                                placeholder=""
                                autoFocus
                            />
                        </div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full h-10 bg-gradient-to-r from-slate-600 to-slate-800 hover:from-slate-700 hover:to-slate-900 text-white font-bold rounded-lg shadow-md hover:shadow-lg transition-all flex justify-center items-center transform active:scale-[0.98]"
                    >
                        {loading ? (
